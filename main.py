...
if __name__ == "__main__":
    ...
    for split in dataset.keys():
        ...
        dataset[split] = dataset[split].add_column("speaking_rate_phn", rate_dataset[split]["speaking_rate_phn"])
        dataset[split] = dataset[split].add_column("speaking_rate_txt", rate_dataset[split]["speaking_rate_txt"])
